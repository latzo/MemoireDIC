...
\documentclass[a4paper,11pt,leqno,openbib,oneside,french]{memoir} %add 'draft' to turn draft option on (see below)
%
%
% Adding metadata:
...
\usepackage{etex}						%eTeX�s extended support for counters
\usepackage{fixltx2e}					%Eliminates some in felicities of the 
%original LaTeX kernel
\usepackage{babel}		%For languages characters and hyphenation
...
%Added packages latyr nee
\usepackage[intoc]{nomencl}
\makenomenclature
\newcommand{\itemcheck}{\item[\checkmark]}
\newcommand{\itemtirait}{\item[$-$]}
%\usepackage{biblatex}
\usepackage{natbib}
%pour les formess rectangles et autres
\usepackage{tikz}
%pour les tables of contents in each part
\usepackage{minitoc}
\setcounter{minitocdepth}{5}
\dominitoc% Initialization
%pour regrouper les lignnes d un tableau
\usepackage{multirow}
%pour inserer un pdf
\usepackage{pdfpages}
...
\DeclareUnicodeCharacter{200B}{$\bullet$}
%\usepackage[intoc]{nomencl}
...
\begin{document}
	...
	\renewcommand{\nomname}{Sigles et Abbréviations}
	...
	\mainmatter
	%
	\import{misc/introduction/}{introduction}
	\import{parts/part01/}{part01.tex} % Présentation Générale
	\import{parts/part02/}{part02.tex} % Etat de l'art sur la sécurite informatique
%	\import{parts/part03/}{part03.tex} % Etat de l'art sur la securite des applications Web
	\import{parts/part04/}{part04.tex} % Analyse et Conception
	\import{parts/part05/}{part05.tex} % Réalisation
	\import{parts/part06/}{part06.tex} % Bilan et Perspectives
	\import{misc/conclusion/}{conclusion}
	...
	%Starting of Bibliography %%%%%
	%\begin{thebibliography}{}
	% \bibitem{InvertedPendulum} "Inverted Pendulum", https://en.wikipedia.org/wiki/Inverted\_pendulum
	
	% \bibitem{2} "Application of Kalman Filteing and PID Control for Direct Inverted Pendulum Control ",  http://csuchico-dspace.calstate.edu/bitstream/handle/10211.4/145/4\%2022\%2009\%20Jose\%20Miranda.pdf?sequence=1
