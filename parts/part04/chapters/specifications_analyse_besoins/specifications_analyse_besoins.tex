...
\begin{itemize}
	\itemtirait L’utilisateur en question est authentifié sur l'application.
\end{itemize}
\underline{\underline{Exigences non fonctionnelles}}
\begin{itemize}
	\itemtirait L’application doit être hébergée sur un serveur protégé par un firewall anti DDoS.\\
\end{itemize}
...
\textbf{Post-condition(s)}
\begin{itemize}
	\itemtirait L’utilisateur en question est déconnecté de l'application.
\end{itemize}
...
\textbf{Post-condition(s)}
\begin{itemize}
	\itemtirait Le nouveau mot de passe est accepté.
\end{itemize}
\underline{\underline{Exigences non fonctionnelles}}
\begin{itemize}
	\itemtirait L’application doit définir une bonne politique de mots de passe.\\
\end{itemize}
\textbf{\RIGHTarrow Diagramme d'activités}\\
