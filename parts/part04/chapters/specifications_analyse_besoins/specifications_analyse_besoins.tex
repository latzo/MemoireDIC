...
\begin{enumerate}
	...
	\item Le système hashe le mot de passe donné et le compare avec celui de l'utilisateur récupéré précedemment.
	\item Le sytème crée une nouvelle session pour l'utilisateur et l'enregistre.
	\item Le systéme enregistre la date et l'heure de connexion 
	\item Le systéme enregistre l'adresse IP de l'hôte ayant envoyé la requête.
	\item Le système journalise la connexion de l'utilisateur.
	\item Le système retourne l'utilisateur modifié.
\end{enumerate}
\textbf{Enchainement(s) d’erreur}\\
\textit{E1 : Utilisateur avec nom d'utilisateur donné inexistant}\\
L’enchaînement E1 démarre au point 2 du scénario nominal.
\begin{itemize}
	\item[3.] Le système logge l'échec de la connexion avec le message "Login ou mot de passe incorrect".
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item[6.a.2.] Le système logge le blocage de l'utilisateur avec le message "Utilisateur bloqué" avec le nom de l'utilisateur.
		...
		\begin{itemize}
			\item[6.b.1] Le système logge l'échec de la connexion avec le message "Tentative de connexion avec une requête non sécurisée".
...
\begin{itemize}
	\item[6.] Le système logge l'échec de la connexion avec le message "Utilisateur expiré" avec le nom de l'utilisateur.
...
\begin{itemize}
	\item[7.] Le système logge l'échec de la connexion avec le message "Utilisateur inactif" avec le nom de l'utilisateur.
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item[10.a.2.] Le système logge le blocage de l'utilisateur avec le message "Utilisateur bloqué" avec le nom de l'utilisateur.
...
%\item[11.] Le système logge l'échec de la connexion avec le message "Délai d'inactivité atteint" avec le nom de l'utilisateur.
...
%	\item[10.] Le système logge l'échec de la connexion avec le message "Session expirée" avec le nom de l'utilisateur.
...
\begin{itemize}
	...
	\begin{itemize}
			...
			\begin{itemize}
				...
				\item[13.a.2.] Le système logge le blocage de l'utilisateur avec le message "Utilisateur bloqué" avec le nom de l'utilisateur.
			...
			\begin{itemize}
				\item[13.b.1] Le système logge l'échec de la connexion avec le message "Login ou mot de passe incorrect".
