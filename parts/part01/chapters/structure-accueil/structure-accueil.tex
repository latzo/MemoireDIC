\chapter{La Structure d'accueil}
...
\section{Quelques Solutions de HubSo }
...
\begin{figure}[h!]
	...
	\end{minipage}
 	...
 	\label{fig:1.1}
\end{figure}
La figure \ref{fig:1.1} représente l'organnigramme de HubSo. HubSo comprend trois départements reliés à la Direction Générale : \\
